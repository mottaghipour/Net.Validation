...
namespace Valtion.Core.Utilities.Exceptions.StringExceptions
{
    ...
    {
        /// <summary>
        /// Constructor <see cref="StringFullReferenceException"/> without parameters
        /// </summary>
        public StringFullReferenceException() : base() { }

        /// <summary>
        /// Constructor <see cref="StringFullReferenceException"/> with <paramref name="message"/>
        /// </summary>
        /// <param name="Message"></param>
        public StringFullReferenceException(string message) : base(message) { }

        /// <summary>
        /// Constructor <see cref="StringFullReferenceException"/> with <paramref name="message"/> and <paramref name="innerException"/>
        /// </summary>
        /// <param name="message"></param>
